...
<div id="information_side">
    <div id="slideshow_div">
        <img id="slideshow" src="../resources/images/image1.png" />
    ...
    <div id="info">
        Data maps is a web application that allows users to create optimized queries 
        in order to exchange data between different databases.
    </div>
</div>
<div id="sign_in_up">
    <div id="render_area">
